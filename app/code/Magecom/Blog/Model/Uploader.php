...
class Uploader
{
     ...
     * @var string
     */
    const IMAGE_TMP_PATH    = 'magecomblog/tmp/images/image';
    /**
     * @var string
     */
    const IMAGE_PATH        = 'magecomblog/images/image';
    /**
     * @var string
     */
    const FILE_TMP_PATH     = 'magecomblog/tmp/images/file';
    /**
     * @var string
     */
    const FILE_PATH         = 'magecomblog/images/file';
